...
addModifyService = function(req, res, next) {
	...
	var service = JSON.parse( JSON.stringify( req.body ) ) ;
...
addFeeder = function(req, res, next) {

	logger.info(`ADMIN - [EDIT TEMPLATE] ${req.params.basepath}`);
	var templateDetail = JSON.parse( JSON.stringify( req.body ) ) ;
...
updateApi = function(req, res, next) {
	...
	var api = JSON.parse( JSON.stringify( req.body ) ) ;
...
addOperation = function(req, res, next) {
	...
	var operation = JSON.parse( JSON.stringify( req.body ) ) ;
...
updateDelay = function(req, res, next) {
        ...
        logger.info(`ADMIN - [EDIT DELAY] ${req.params.basepath}`);
				...
				var newDelay = JSON.parse( JSON.stringify( req.body ) ) ;
...
exports.createAdmin = function () {
	...
	server.post('/:basepath/addFeeder', addFeeder);
