...
var runContext = require(__base + 'lib/core/utils/runContext');
//all steps
var stepRequest = require(__base + 'lib/core/steps/request');
var stepPost = require(__base + 'lib/core/steps/post');
var stepParam = require(__base + 'lib/core/steps/param');
var stepDispatch = require(__base + 'lib/core/steps/dispatch');
var stepResponse = require(__base + 'lib/core/steps/response');
