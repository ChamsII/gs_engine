...
var BodyJsonPathExtractor = require(__base + 'lib/data/tp/bodyJsonPathExtractor.js');
...
var TPExtractor = function TPExtractor(){
    ...
    this.extractor[this.src.JSON_PATH]=BodyJsonPathExtractor;
    ...
    this.extract = function(tp, request, runCtxt, callback){
    	...
    	this.extractor[tp.source].extract(tp, request, runCtxt, (err,value)=>{
            ...
            //Si la TP est une clé, on stocke la valeur en supprimant certains caractères spéciaux (")
            if(tp.isKey){
