...
var TLVExtractor = function TLVExtractor(){
    ...
    this.extract = function(tp, request, runCtxt, callback){
        ...
        var length = parseInt(trame.substring(index+this.typeSize,index+this.typeSize+this.lengthSize));

        var value = trame.substring(index+this.typeSize+this.lengthSize,index+this.typeSize+this.lengthSize+length);
